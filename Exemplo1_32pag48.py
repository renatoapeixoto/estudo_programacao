# Dados três valores, X, Y, Z, verificar se eles podem ser os comprimentos dos lados de um triângulo e, se forem,
# verificar se é um triângulo equilátero, isósceles ou escaleno. Se eles não formarem um triângulo, escrever uma mensagem.
